...
class AgentProcessManager:
    ...
    def create_process(self, definition: AgentDefinition, background: bool = False) -> AgentProcess:
        ...
        try:
            ...
            if process.definition.system_prompt:
                process.context.append({
                    "role": "system",
                    "content": process.definition.system_prompt
                })
            ...
            process.error_buffer = f"Agent execution timed out after {process.definition.timeout} seconds"
    ...
    def cleanup_completed(self):
        ...
        completed_pids = [
            ...
            if proc.state in [ProcessState.COMPLETED, ProcessState.FAILED, ProcessState.TERMINATED]
        ]
