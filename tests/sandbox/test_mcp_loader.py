...
async def test_load_mcp_tools_for_server():
    ...
    try:
        ...
        mock_send_tools_list.return_value = {"tools": [{"name": "toolA"}, {"name": "toolB"}]}
...
async def test_register_mcp_commands():
    ...
    # Mock both functions
    with patch("chuk_virtual_shell.commands.mcp.mcp_command_loader.load_mcp_tools_for_server", side_effect=fake_load_tools), \
         patch("chuk_virtual_shell.commands.mcp.mcp_command_loader.create_mcp_command_class", side_effect=fake_create_command):
...
async def test_mcp_loader_integration():
    ...
    with patch.dict('sys.modules', {
        ...
        sys.modules['chuk_virtual_shell.commands.mcp.mcp_command_loader'].register_mcp_commands = AsyncMock()
