...
class TestAgentProcess:
    ...
    def test_process_creation(self):
        ...
        assert process.background == False
...
class TestAgentProcessManager:
    ...
    async def test_run_process_success(self):
        ...
        with patch.object(self.manager.llm_interface, 'generate', new_callable=AsyncMock) as mock_generate:
    ...
    async def test_run_process_timeout(self):
        ...
        with patch.object(self.manager.llm_interface, 'generate', side_effect=slow_generate):
