...
import pytest
from chuk_virtual_shell.agents.agent_definition import AgentDefinition, IOMode, MemoryMode
...
"""
    ...
    def test_invalid_agent_missing_shebang(self):
        """Test that agent without shebang raises error"""
        agent_content = """name: invalid_agent
model: gpt-3.5-turbo
"""
        
        with pytest.raises(ValueError, match="missing #!agent shebang"):
